...
<div class="main-header">
    ...
    <p>Tác giả: Cao Văn Quảng - Trường PTDTBT Tiểu học Chế Là - ĐT: 0835527888</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Cao Văn Quảng - Trường PTDTBT Tiểu học Chế Là - ĐT: 0835527888</div>", unsafe_allow_html=True)
